...
export async function getStaticProps() {
  //getStaticProps와 해당 api폴더에서 await res.revalidate("/community"); 를 쓰면 작성과 동시에 즉각 데이터가 포함된 html
  //원래는 validate 시간이 필요했고 누군가 봐야지만 해당시간이후 업데이트 되어서 build파일에 데이터가 포함된 html을 생성해줬음
  //빌드할때만실행
